...
export default function Sidebar() {
  ...
  return (
    <div className='w-2/12 bg-[#212121] pr-5 overflow-auto pb-8 sidebar'>
      ...
      <span className='px-4 text-sm text-zinc-400'> &copy; 2023 Nikhil Rajolia</span>
      <br />
      <p className='px-4 pt-3 text-sm text-zinc-400'> This YouTube developed by Nikhil Rajolia.</p>
    </div>
